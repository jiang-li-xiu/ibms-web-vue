 ...
 * @return {*}
 */
export function print(printable, title, type, jsonData, borderHeadStyle, gridStyle, style) {
    return printJS({
        printable: printable,//id，json...
        ...
        gridStyle: gridStyle || 'font-size:1px;font-weight:200;border: 1px solid #ccc;padding:3px 5px 3px 5px;text-align:center;',//json各式表哥样式
