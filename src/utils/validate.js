 ...
 * @LastEditTime: 2022-02-17 10:30:54
 */
/**
 * @param {string} path
 * @returns {Boolean}
 ...
 * @returns {Boolean}
 */
export function validSpecialCharacters(specialCharacters) {
  const reg = new RegExp("[^a-zA-Z0-9\_\u4e00-\u9fa5]", "i")
  return reg.test(specialCharacters)
}
