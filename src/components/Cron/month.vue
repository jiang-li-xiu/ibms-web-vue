<template lang="html">
  <div :val="value_">
    ...
    <div class="bottom">
      ...
      <el-checkbox-group v-model="appoint" style="margin-left: 0;  line-height: 25px;">
        <el-row :gutter="20">
          <el-col :span="4" v-for="i in 12" :key="i" :label="i" style="margin-left: 0; line-height: 25px;">
            <el-checkbox @change="type = '4'" :key="i" :label="i"></el-checkbox>
          </el-col>
        </el-row>
      </el-checkbox-group>
    </div>
