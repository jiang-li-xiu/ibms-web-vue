 ...
 * @LastEditTime: 2022-05-17 16:27:03
-->
<template>
  <div>
      ...
      >
        ...
        <el-table-column label="状态" width="60" align="center">
          <template slot-scope="scope">
            <span style="color: #95f204" v-if="scope.row.status == 0"
              >在线</span
            >
            <span style="color: #d9001b" v-else>离线</span>
          </template>
        </el-table-column>
        <el-table-column label="上次抄表读数" width="100" align="center">
          <template slot="header"> 上次抄表读数 <br />度(KWh) </template>
          <template slot-scope="scope">
            <span>{{ scope.row.oldValue }}</span>
          </template>
        </el-table-column>
        <el-table-column label="本次抄表读数" width="100" align="center">
          <template slot="header"> 本次抄表读数 <br />度(KWh) </template>
          <template slot-scope="scope">
            <span>{{ scope.row.curValue }}</span>
          </template>
        </el-table-column>
        <el-table-column label="用量" width="100" align="center" prop="value">
          <template slot="header"> 用量 <br />度(KWh) </template>
          <template slot-scope="scope">
            <span>{{ scope.row.value }}</span>
          </template>
        </el-table-column>
        <el-table-column label="单价" width="120" align="center">
          <template slot="header"> 用量 <br />元/度(KWh) </template>
          <template slot-scope="scope">
