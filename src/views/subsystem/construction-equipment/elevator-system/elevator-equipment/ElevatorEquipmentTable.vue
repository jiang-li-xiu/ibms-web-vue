...
import { getEquipmentList } from "@/api/subsystem/construction-equipment/elevator/ElevatorEquipment.js";
import ElevatorEquipmentDetail from "./ElevatorEquipmentDetail"
export default {
  mixins: [TableListMixin],
  name: "ElevatorEquipmentTable",
  components: {
    ElevatorEquipmentDetail,
  },
  props: {
    treeNode: Object,
  },
