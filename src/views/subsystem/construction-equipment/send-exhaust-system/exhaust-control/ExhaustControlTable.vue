 ...
 * @Descripttion: 
 * @Author: ZhouYongqiu
 * @Date: 2022-04-07 09:20:23
 * @LastEditors: ZhouYongqiu
 * @LastEditTime: 2022-05-24 17:18:11
-->
<template>
  <el-card class="min-height-124">
    ...
    <exhaust-detail ref="modelForm"></exhaust-detail>

  </el-card>
</template>
<script>

import { getEquipmentList } from "@/api/subsystem/send-exhaust-system/exhaustControl";
import { TableListMixin } from "@/mixins/TableListMixin";
import ExhaustDetail from "./ExhaustDetail";
export default {
  name: "ExhaustControlTable",
  components: {
    ExhaustDetail,
  },
  props: {
