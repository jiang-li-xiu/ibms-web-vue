 ...
 * @LastEditTime : 2022-04-19 17:48:35
 * @LastEditors  : Imor
 * @FilePath     : \ibms-web-vue\src\views\visualization\device-access-control\index.vue
 * @Description  : 
-->
<template>
          ...
          <div class="shortcut_help">
            ...
            >
              <div slot class="edit_helper_text">
                ...
                <b>5.区域查询：</b>区域列表的搜索栏可通过模糊搜索查询区域；
                <p style="color: red">
