 ...
 * @LastEditTime: 2022-03-29 11:36:13
-->
<template>
  <div>
    <el-dialog
    ...
    >
      ...
      >
        <el-row>
          <el-col :span="24">
            <el-form-item label="通知配置" prop="template">
              <el-select
              ...
              >
                <el-option
                  v-for="(template, i) in configOptions"
                  :key="i"
                  :label="template.name"
                  :value="template.id"
                ></el-option>
...
export default {
  ...
  methods: {
    ...
    configChange(value) {
      this.form.configId = value;

      getVariableFields(this.form.templateId).then((res) => {
